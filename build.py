...
ORDER = ['config.js', 'sp.js', 'schema.js', 'usersync.js', 'perms.js', 'syncstate.js', 'icons.js', 'styles.js', 'ui.js', 'grid.js', 'usersview.js', 'reqview.js', 'compare.js', 'help.js', 'audit.js', 'backup.js', 'settings.js', 'importcsv.js', 'xlsx.js', 'xlsxflow.js', 'updater.js', 'main.js']
