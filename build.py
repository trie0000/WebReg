...
ORDER = ['config.js', 'sp.js', 'schema.js', 'usersync.js', 'perms.js', 'icons.js', 'styles.js', 'ui.js', 'grid.js', 'notify.js', 'usersview.js', 'settings.js', 'importcsv.js', 'updater.js', 'main.js']
